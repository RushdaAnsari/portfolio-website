  ...
  return (
    <div className=''>
        <div className='flex mx-auto w-full justify-end items-center page-number absolute h-5 z-0'>
                <p className='flex text-bold text-[#a09881] text-[50px] px-5'>02</p>
        </div>
        <section className="flex flex-col lg:py-48 py-28" id="about">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
            >
                <div className="about-paragraph flex flex-col gap-2 text-lg px-2">
                <p className='lh-base'>
                    Welcome, My name is Rushda. I am a self-taught{" "} 
